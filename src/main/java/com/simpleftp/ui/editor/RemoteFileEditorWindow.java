 ...
 */
public class RemoteFileEditorWindow extends FileEditorWindow {
    /**
    ...
    String getSaveFilePath() throws Exception {
        ...
        if (file.isSymbolicLink()) {
             ...
             */
            FTPConnection connection = creatingPane.getFileSystem().getFTPConnection();
            return UI.resolveRemotePath(targetPath, creatingPane.getCurrentWorkingDirectory(), true, connection);
        }
